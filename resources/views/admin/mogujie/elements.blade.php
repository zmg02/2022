@include('admin.mogujie.layouts.head',['title'=>'表单'])
...
<!--End 左侧导航-->
    ...
    <!--头部信息-->
@include('admin.mogujie.layouts.header',['title'=>'表单'])
    <!--End 头部信息-->
          ...
          <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form action="{{ url('admin/mogujie/index/elements') }}" method="post" onsubmit="return false;">
                  <div class="form-group">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form class="form-inline" action="{{ url('admin/mogujie/index/elements') }}" method="post" onsubmit="return false;">
                  <div class="form-group">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <form class="form-horizontal" action="{{ url('admin/mogujie/index/elements') }}" method="post" onsubmit="return false;">
                  <div class="form-group">
