...
<body style="background-image: url(/img/mogujie/admin/login-bg-2.jpg); background-size: cover;">
<div class="bg-translucent p-10">
  <div class="login-box bg-white clearfix">
    ...
    <div class="login-right">
      <p><img src="/img/mogujie/admin/logo.png" class="m-b-md m-t-xs" alt="logo"></p>
