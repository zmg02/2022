...
<!--颜色选择插件-->
<link rel="stylesheet" href="/js/mogujie/admin/bootstrap-colorpicker//css/mogujie/admin/bootstrap-colorpicker.min.css">
          ...
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav active open">
              ...
              <ul class="nav nav-subnav">
                ...
                <li class="active"> <a href="{{ url('admin/mogujie/index/colorpicker') }}">选色器</a> </li>
