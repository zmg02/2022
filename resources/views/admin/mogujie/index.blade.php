...
<title>首页 - 2022后台管理系统模板</title>
<link rel="icon" href="favicon.ico" type="image/ico">
<meta name="keywords" content="2022后台管理系统模板,2022,后台模板,后台管理系统,2022HTML模板">
<meta name="description" content="2022是一个基于Bootstrap v3.3.7的后台管理系统的HTML模板。">
<meta name="author" content="zmg">
      ...
      <div class="lyear-layout-sidebar-scroll">
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            <li class="nav-item active"> <a href="{{ url('admin/mogujie') }}"><i class="mdi mdi-home"></i> 后台首页</a> </li>
