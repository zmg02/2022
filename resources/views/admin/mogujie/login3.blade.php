...
<body>
<div class="row lyear-wrapper" style="background-image: url(/img/mogujie/admin/login-bg-3.jpg); background-size: cover;">
  <div class="lyear-login">
    <div class="login-center">
      <div class="login-header text-center">
        <a href="{{ url('admin/mogujie') }}"> <img alt="light year admin" src="/img/mogujie/admin/logo-sidebar.png"> </a>
      </div>
      <form action="#!" method="post">
        ...
        <div class="form-group">
          <button class="btn btn-block btn-primary" type="button" onclick="location.href='{{ url('admin/mogujie') }}'">立即登录</button>
        </div>
      </form>
