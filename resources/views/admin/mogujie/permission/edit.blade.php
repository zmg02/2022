...
<!--头部信息-->
@include('admin.mogujie.layouts.header',['title'=>'修改权限'])
<!--End 头部信息-->
              ...
              <div class="form-body">
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    ...
                    <input type="hidden" name="parent_id" class="parent" value="{{$permission['parent_id']}}">
                    <div class="nav">
                      <p class="set">{{$permission['parent_name']}}</p>
                      <ul class="new">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control @error('slug') is-invalid @enderror" value="{{$permission['slug']}}" type="text" name="slug" placeholder="administrator">
                    @error('slug')
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control @error('name') is-invalid @enderror" value="{{$permission['name']}}" type="text" name="name" placeholder="Administrator">
                    @error('name')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" value="{{$permission['http_method']}}" type="text" name="http_method" placeholder="HTTP method">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" value="{{$permission['http_path']}}" type="text" name="http_path" placeholder="HTTP path">
                  </div>
                </div>
  ...
  $(function() {
    ...
    $(function() {
      $('.btn-reset').click(function() {
        window.location.href = '{{route("permission.edit",[$permission["id"]])}}';
      })
    });
  })
</script>