@include('admin.mogujie.layouts.head',['title'=>'示例页面 - 设置权限'])
...
<!--头部信息-->
@include('admin.mogujie.layouts.header',['title'=>'示例页面 - 设置权限'])
    <!--End 头部信息-->
...
<script type="text/javascript" src="/js/mogujie/admin/chosen.jquery.min.js"></script>
