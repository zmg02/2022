...
<body>
	...
	<section class="content">
		<div class="fen">
			<span class="sp1">所有分类<b>></b></span>
		<!--   <span class="sp2">纯色<b class="close1">x</b></span> -->
			<span class="clear-all"><b class="close2">x</b>清除所有</span>
		</div>
		<ul class="select">
			<li>
				<p>分类</p>
		...
		<div class="zong">
			<span class="cli-red">综合</span> <!--class="cli-red"-->
			<span>销量</span>
			<span>新品</span>
			<aside>
				<form action="#">
					<span class="fom-sp">￥<input type="text">
					</span>
					<span class="fom-mid">-</span>
					<span class="fom-sp">￥<input type="text">
					</span>
				</form>
				<span class="sure">确定</span>
				<span class="pric">60-70</span>
				<span class="pric prictw">70-80</span>
				<span class="pric">80-90</span>
			</aside>
		</div>
		<div class="nine">
				<ul>
